...
import com.centaury.data.tvshow.repository.source.local.entity.TVShowEntity.Companion.COLUMN_TITLE
 ...
 */
@Entity(
    tableName = TABLE_NAME_TV_SHOW,
    indices = [Index(value = [COLUMN_TITLE])]
)
