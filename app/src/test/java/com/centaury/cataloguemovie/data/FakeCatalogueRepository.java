...
public class FakeCatalogueRepository implements CatalogueDataSource {
    ...
    public FakeCatalogueRepository(@NonNull LocalRepository localRepository, @NonNull RemoteRepository remoteRepository) {
        this.localRepository = localRepository;
        this.remoteRepository = remoteRepository;
    }

    public static FakeCatalogueRepository getInstance(LocalRepository localRepository, RemoteRepository remoteData) {
        if (INSTANCE == null) {
            synchronized (RemoteRepository.class) {
                if (INSTANCE == null)
                    INSTANCE = new FakeCatalogueRepository(localRepository, remoteData);
            }
        }
