...
public class DetailMovieActivityTest {
    ...
    public void loadMovie() {
        ...
        onView(withId(R.id.txt_title_detail)).check(matches(withText(detailMovieResponse.getTitle())));
        onView(withId(R.id.txt_desc_detail)).check(matches(isDisplayed()));
        onView(withId(R.id.txt_desc_detail)).check(matches(withText(detailMovieResponse.getOverview())));
    }
